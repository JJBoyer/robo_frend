...
#define LEFT_DIR1_PIN GPIO_NUM_7   // Connects to IN1 on driver
#define LEFT_DIR2_PIN GPIO_NUM_6   // Connects to IN2 on driver
#define RIGHT_DIR1_PIN GPIO_NUM_5  // Connects to IN3 on driver
#define RIGHT_DIR2_PIN GPIO_NUM_4  // Connects to IN4 on driver
